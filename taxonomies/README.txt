...
* `all-vertebrate.tsv` was copied from /dgd-analysis/taxonomy-lists/2020-04/taxa.tsv and parsed as described in that directory. It contains all vertebrate-associated viruses (as of late April 2020).
